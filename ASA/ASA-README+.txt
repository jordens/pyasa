     ...
     ******************************************************************/
     ...
     use  of  ASA for optimization and sampling[36,37,38,39,40,41,42].  The
     ...
     used  to  define the constituents of the PROJECT struct.  As described
     above in the DLL ASA-Makefile sub-Section of Section 7, ASA_LIB can be
     used to create a DLL to be called by Windows programs.
     ...
     *User_Quench_Cost_Scale and User_Quench_Param_Scale [] all are read in
     ...
     tuning  of  these  options.   Also, it is possible you might crash the
     ...
     *initial_cost_temperature to that value, but the best  value  for  the
     ...
     [1m9.1.51.  ASA_BYPASS=FALSE[0m

          In asa_usr.c ASA_BYPASS has been added to  simply  bypass  asa().
     At the top of asa_usr.c the trigger is
     #ifndef ASA_BYPASS
     #define ASA_BYPASS FALSE
     #endif
     which  can  be  simply changed.  This can be useful to debug codes, to
     run the FITLOC simplex code after a good  region  is  developed  using
     asa(), etc. A nominal value of cost_value of 10000 has been set, which
     can easily be changed.

     [1m9.1.52.  ASA_QUEUE=FALSE[0m
     ...
     [1m9.1.53.  ASA_RESOLUTION=FALSE[0m
     ...
     *ASA_FUZZY_Init_User_Quench_Cost_Scale  which  may  be used to restore
     ...
     [1m9.1.55.  ASA_FUZZY_PRINT=FALSE[0m
     ...
     *Multi_Grid, and Multi_Specify become available.  In asa_usr.c, memory
     ...
     [1m9.1.60.  ASA_PARALLEL=FALSE[0m
     ...
     *exit_status  can  be  extremely  deceptive,  especially   in   highly
     ...
     [42] L. Ingber, "Forecasting  COVID-19  with  importance-sampling  and
          path-integrals,"  Report  2020:FCIP,  Physical Studies Institute,
          Ashland, OR  (2020).  URL  https://www.ingber.com/asa20_covid.pdf
          and https://doi.org/10.2139/ssrn.3691967.
     ...
     9.1.51.             ASA_BYPASS=FALSE . . . . . . . . . . . . . . .  29
     9.1.52.             ASA_QUEUE=FALSE  . . . . . . . . . . . . . . .  29
     9.1.53.             ASA_RESOLUTION=FALSE . . . . . . . . . . . . .  30
     9.1.54.             ASA_FUZZY=FALSE  . . . . . . . . . . . . . . .  30
     9.1.55.             ASA_FUZZY_PRINT=FALSE  . . . . . . . . . . . .  31
     9.1.56.             FITLOC=FALSE . . . . . . . . . . . . . . . . .  31
     9.1.57.             FITLOC_ROUND=TRUE  . . . . . . . . . . . . . .  31
     9.1.58.             FITLOC_PRINT=TRUE  . . . . . . . . . . . . . .  31
     9.1.59.             MULTI_MIN=FALSE  . . . . . . . . . . . . . . .  32
     9.1.60.             ASA_PARALLEL=FALSE . . . . . . . . . . . . . .  32
     9.1.61.             FDLIBM_POW=FALSE . . . . . . . . . . . . . . .  33
     9.1.62.             FDLIBM_LOG=FALSE . . . . . . . . . . . . . . .  33
     9.1.63.             FDLIBM_EXP=FALSE . . . . . . . . . . . . . . .  34
     ...
     9.3.10.             OPTIONS->Temperature_Anneal_Scale[100.0]
      . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  43
     9.3.11.             OPTIONS->User_Cost_Temperature . . . . . . . .  44
     ...
     ture[1.0]  . . . . . . . . . . . . . . . . . . . . . . . . . . . .  45
     9.3.16.             OPTIONS->User_Temperature_Ratio  . . . . . . .  45
     ...
     9.3.44.             OPTIONS->Cost_Schedule . . . . . . . . . . . .  53
     ...
     9.3.49.             OPTIONS->Cost_Temp_Curr  . . . . . . . . . . .  54
     ...
     9.3.56.             OPTIONS->Reanneal_Params_Function  . . . . . .  55
     9.3.57.             OPTIONS->Bias_Acceptance . . . . . . . . . . .  55
     ...
     9.3.62.             OPTIONS->Queue_Resolution  . . . . . . . . . .  56
     ...
     10.21.         void print_time(char *message, FILE * ptr_out)
      . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .  71
     10.22.         void sample(FILE * ptr_out, FILE * ptr_asa) . . . .  71
